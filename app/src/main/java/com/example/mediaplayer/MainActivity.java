...
public class MainActivity extends AppCompatActivity implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener {
        ...
        try {
            switch (view.getId()) {
                ...
                case R.id.btnRAW:
                    ...
                    toast.show(); // демонстрация тоста на экране
                    mediaPlayer = MediaPlayer.create(this, R.raw.bit); // создание дорожки с имеющимся аудио-файлом
                    mediaPlayer.start(); // старт данной дорожки
                    nameAudio = "Shiva Raw - Gothic"; // инициализация названия контента
                    break;
                case R.id.btnSD:
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btnHigher:
                volume += 0.3f;
                mediaPlayer.setVolume(volume, volume); // метод остановки
                break;
            case R.id.btnLower:
                volume += 0.3f;
                mediaPlayer.setVolume(volume, volume); // переход к определённой позиции трека
